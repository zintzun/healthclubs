<?php
	...
	//////////////////////////////////////////////////
	/*
	move_uploaded_file($_FILES['Filedata']['tmp_name'], "/jjj.jpg");
    [biz_id] => 271
    [pic_type] => listing
    [img_src_path] => C:\Windows\Temp\phpDEAF.tmp
	...
	*/
	...
	include "/www/tds/web/interfaces/biz/biz_img.inc";
